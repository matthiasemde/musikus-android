...
class LibraryScreenTest {
    ...
    fun clickFab_multiFabMenuIsShown() {
        ...
        composeRule.onNodeWithContentDescription("Add folder").assertIsDisplayedWithLease()
        composeRule.onNodeWithContentDescription("Add item").assertIsDisplayedWithLease()
    }
    ...
    fun addFolderOrItem_hintDisappears() {
        ...
        composeRule.onNodeWithText(context.getString(R.string.library_screen_hint)).assertIsDisplayedWithLease()

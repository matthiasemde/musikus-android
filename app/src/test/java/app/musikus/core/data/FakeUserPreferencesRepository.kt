...
class FakeUserPreferencesRepository : UserPreferencesRepository {
    ...
    private val _preferences = MutableStateFlow(
        UserPreferences(
            ...
            appIntroDone = false,
            libraryFolderSortMode = LibraryFolderSortMode.Companion.DEFAULT,
            libraryFolderSortDirection = SortDirection.Companion.DEFAULT,
            libraryItemSortMode = LibraryItemSortMode.Companion.DEFAULT,
            libraryItemSortDirection = SortDirection.Companion.DEFAULT,

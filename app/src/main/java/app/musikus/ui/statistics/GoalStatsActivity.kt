...
//            labelCount = X_AXIS_LABEL_COUNT_NORMAL
            ...
            textColor = Musikus.getThemeColor(R.attr.colorOnSurface, this@GoalStatsActivity)
        }
        ...
        barChart.axisRight.apply {
            ...
            textColor = Musikus.getThemeColor(R.attr.colorOnSurfaceLowerContrast, this@GoalStatsActivity)
    ...
    private fun updateChartData() {
        ...
        if (barChart.data != null && barChart.data.dataSetCount > 0) {
            ...
            dataSetBarChart.apply {
                ...
                color = getChartColor()
                highLightColor = Musikus.getThemeColor(R.attr.colorOnSurface, this@GoalStatsActivity)
            ...
            barData.apply {
                ...
                setValueTextColor(Musikus.getThemeColor(R.attr.colorOnSurfaceLowerContrast, this@GoalStatsActivity))
    ...
    private fun getVerticalLimitLine(limit: Float, label: String): LimitLine {
        return LimitLine(limit, label).apply {
            lineWidth = 3f
            lineColor = Musikus.getThemeColor(R.attr.colorOnSurfaceLowerContrast, this@GoalStatsActivity)
        ...
        for (i in firstGoalInstShownIndex..lastGoalInstShownIndex) {
            ...
            if (i >= 0 && yVal >= allInstances[i].target) {
                ...
                DrawableCompat.setTint(iconDrawable,
                    Musikus.getThemeColor(R.attr.colorSurface, this))
    ...
    private inner class GoalStatsAdapter : RecyclerView.Adapter<GoalStatsAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            if (elem.libraryItem != null) {
                ...
                holder.goalRadioButton.buttonTintList = ColorStateList.valueOf(Musikus.getThemeColor(R.attr.colorPrimary, this@GoalStatsActivity))

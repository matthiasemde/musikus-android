...
import app.musikus.shared.setCommonToolbar
...
//                }
    ...
    /**
     * Musikus "last 7 days" quick glimpse chart
     */
    private fun initLast7DaysCard() {
        ...
        lastDaysChart.xAxis.apply {
            ...
            textColor = Musikus.getThemeColor(R.attr.colorOnSurface, requireActivity())
        }
    ...
    private fun setLast7DaysChartData(lastDaysChart: BarChart) {
        lifecycleScope.launch {
            ...
            dataSetBarChart.apply {
                setDrawValues(false)
                color = Musikus.getThemeColor(R.attr.colorPrimary, requireActivity())
            }
    ...
    private fun initRatingsCard() {
        ...
        ratingsChart.apply {
            ...
            setEntryLabelColor(Musikus.getThemeColor(R.attr.colorOnSurfaceLowerContrast, requireContext()))
        ...
        lifecycleScope.launch {
            ...
            dataset.apply {
                colors = Musikus.getLibraryItemColors(requireContext())
                setDrawValues(false)
